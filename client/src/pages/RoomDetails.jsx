...
const RoomDetails = () => {
  ...
  useEffect(() => {
    ...
    room && setRoom(room);
    room && setMainImage(room.images[0]); // Set the first image as the main image
  }, [id]);
      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            availability. You get a comfortable Two bedroom apartment and it has
            a true city feeling. The price quoted is for two guest, at the guest
            slot please mark thhe number of guests to get the exact price for
            groups.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="flex gap-4">
            <img
              ...
              alt="Host"
              className="object-cover w-14 h-14 md:h-18 md:w-18 rounded-full"
            />
            <div>
          ...
          <button className="bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded mt-4 px-6 py-2.5 text-base cursor-pointer">
            Contact Host
          </button>
        </div>
      </div>
